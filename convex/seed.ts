...
export const seedRoadmap = mutation({
  ...
  handler: async (ctx) => {
    ...
    if (existingPhases.length > 0) {
      return { message: "Roadmap already seeded", count: existingPhases.length };
    }
    ...
    // Phase 1 weeks (index 0)
    await ctx.db.insert("roadmapWeeks", {
      phaseId: phaseIds[0] as any,
      order: 1,
      title: "Dart Basics",
    ...
    // Phase 2 weeks (index 1)
    await ctx.db.insert("roadmapWeeks", {
      phaseId: phaseIds[1] as any,
      order: 5,
      title: "Flutter Setup & Basics",
      estimatedHours: "20–25 hours",
      topics: [
    ...
    await ctx.db.insert("roadmapWeeks", {
      phaseId: phaseIds[1] as any,
      order: 8,
      title: "Theming, Styling & Animations",
      estimatedHours: "22–28 hours",
      topics: [
    ...
    await ctx.db.insert("roadmapWeeks", {
      phaseId: phaseIds[1] as any,
      order: 9,
      title: "Essential Packages & Utilities",
      estimatedHours: "18–22 hours",
      topics: [
        "Package: flutter_svg — SVG rendering",
        "Package: cached_network_image — Image caching",
        "Package: shimmer — Loading effects",
        "Package: intl — Date/number formatting",
        "Package: url_launcher — Open URLs",
        "Package: image_picker — Camera & gallery",
        "Package: permission_handler — Permissions",
        "Package: connectivity_plus — Network status",
    ...
    // Phase 3 weeks (index 2)
    await ctx.db.insert("roadmapWeeks", {
      phaseId: phaseIds[2] as any,
      order: 10,
      title: "Cubit Basics",
      estimatedHours: "22–28 hours",
      topics: [
    ...
    // Phase 4 weeks (index 3)
    await ctx.db.insert("roadmapWeeks", {
      phaseId: phaseIds[3] as any,
      order: 14,
    ...
    await ctx.db.insert("roadmapWeeks", {
      phaseId: phaseIds[3] as any,
      order: 15,
      title: "API Integration with Cubit",
      estimatedHours: "22–28 hours",
      topics: [
    ...
    // Phase 5 weeks (index 4)
    await ctx.db.insert("roadmapWeeks", {
      phaseId: phaseIds[4] as any,
      order: 17,
    ...
    // Phase 6 weeks (index 5)
    await ctx.db.insert("roadmapWeeks", {
      phaseId: phaseIds[5] as any,
      order: 19,
      title: "Advanced UI & Custom Widgets",
      estimatedHours: "22–28 hours",
      topics: [
    ...
    // Phase 7 weeks (index 6)
    await ctx.db.insert("roadmapWeeks", {
      phaseId: phaseIds[6] as any,
      order: 23,
    ...
    await ctx.db.insert("roadmapWeeks", {
      phaseId: phaseIds[6] as any,
      order: 24,
      title: "Design Patterns & Advanced Architecture",
      estimatedHours: "22–28 hours",
      topics: [
    ...
    // Phase 8 weeks (index 7)
    await ctx.db.insert("roadmapWeeks", {
      phaseId: phaseIds[7] as any,
      order: 26,
    ...
    // Phase 9 weeks (index 8)
    await ctx.db.insert("roadmapWeeks", {
      phaseId: phaseIds[8] as any,
      order: 28,
      title: "Firebase Core",
      estimatedHours: "25–30 hours",
      topics: [
    ...
    await ctx.db.insert("roadmapWeeks", {
      phaseId: phaseIds[8] as any,
      order: 30,
      title: "Additional Backend Services",
      estimatedHours: "20–25 hours",
      topics: [
    ...
    // Phase 10 weeks (index 9)
    await ctx.db.insert("roadmapWeeks", {
      phaseId: phaseIds[9] as any,
      order: 31,
    ...
    await ctx.db.insert("roadmapWeeks", {
      ...
      projects: [
        "Build complete E-Commerce app with all features",
      ],
    });
    ...
    await ctx.db.insert("roadmapWeeks", {
      phaseId: phaseIds[9] as any,
      order: 33,
      title: "Project 2: Social Media / Chat App 🏆",
      ...
      projects: [
        "Build complete Social Media / Chat app with all features",
      ],
    });
    ...
    await ctx.db.insert("roadmapWeeks", {
      phaseId: phaseIds[9] as any,
      order: 34,
      title: "Project 3: Productivity / Task Manager App 🏆",
      ...
      projects: [
        "Build complete Productivity / Task Manager app with all features",
      ],
    });

    return { message: "Roadmap seeded successfully", count: phases.length };
  },
});
