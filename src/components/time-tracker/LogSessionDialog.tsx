...
import { Plus, Clock, Loader2, AlertCircle, Calendar } from "lucide-react";
...
export function LogSessionDialog({ defaultWeekId }: LogSessionDialogProps) {
  ...
  const hasErrors = useMemo(() => Object.keys(validate()).length > 0, [validate]);
        ...
        >
                ...
                <div className="flex items-center gap-2">
                  <Input
                    ...
                    className={cn(
                      ...
                      showHoursError && "border-red-500/50 focus-visible:ring-red-500/50"
                    )}
                    placeholder="0"
                  />
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2">
                  <Input
                    ...
                    className={cn(
                      "border-white/10 bg-white/5 text-center font-mono text-lg",
                      showMinutesError && "border-red-500/50 focus-visible:ring-red-500/50"
                    )}
                    placeholder="0"
                  />
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              className={cn(
                "border-white/10 bg-white/5 resize-none h-20",
                showNotesError && "border-red-500/50 focus-visible:ring-red-500/50"
              )}
            />
            <AnimatePresence>
              {showNotesError && (
